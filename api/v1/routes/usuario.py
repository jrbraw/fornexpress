...
from schemas.usuario_schema import UsuarioSchema, UsuariosSchemaPost
...
async def post_usuario(
    usuario: UsuariosSchemaPost, db: AsyncSession = Depends(get_session)
):
    """
...
@router.get(
    ...
    response_model=CustomPage[UsuarioSchema],
    response_description="OK",
)
...
async def put_usuario(usuario: UsuarioSchema, db: AsyncSession = Depends(get_session)):
    """
